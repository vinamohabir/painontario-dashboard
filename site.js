...
(function(){
  ...
  /* v2 — fewer dots, more negative space. 320×120 tile with 12 dots clustered
     so empty zones balance the colored ones. Sizes vary 1.5-3px. */
  var svgLight = '<svg xmlns="http://www.w3.org/2000/svg" width="320" height="120" viewBox="0 0 320 120" preserveAspectRatio="none"><g opacity=".5"><circle cx="22" cy="28" r="2.5" fill="%231F6B7E"/><circle cx="60" cy="86" r="2" fill="%23b6d6c8"/><circle cx="98" cy="40" r="1.5" fill="%23dc7878"/><circle cx="142" cy="74" r="3" fill="%23caa46a"/><circle cx="186" cy="22" r="2" fill="%23b6d6c8"/><circle cx="218" cy="64" r="1.5" fill="%231F6B7E"/><circle cx="254" cy="98" r="2.5" fill="%23dc7878"/><circle cx="288" cy="34" r="2" fill="%23caa46a"/><circle cx="306" cy="92" r="1.5" fill="%23b6d6c8"/><circle cx="44" cy="62" r="1" fill="%23dc7878"/><circle cx="172" cy="100" r="1" fill="%231F6B7E"/><circle cx="240" cy="14" r="1" fill="%23caa46a"/></g></svg>';
  var svgDark = '<svg xmlns="http://www.w3.org/2000/svg" width="320" height="120" viewBox="0 0 320 120" preserveAspectRatio="none"><g opacity=".65"><circle cx="22" cy="28" r="2.5" fill="%239bd6e8"/><circle cx="60" cy="86" r="2" fill="%23b6d6c8"/><circle cx="98" cy="40" r="1.5" fill="%23f6c1a3"/><circle cx="142" cy="74" r="3" fill="%23caa46a"/><circle cx="186" cy="22" r="2" fill="%23b6d6c8"/><circle cx="218" cy="64" r="1.5" fill="%239bd6e8"/><circle cx="254" cy="98" r="2.5" fill="%23f6c1a3"/><circle cx="288" cy="34" r="2" fill="%23caa46a"/><circle cx="306" cy="92" r="1.5" fill="%23f5ecd2"/><circle cx="44" cy="62" r="1" fill="%23f6c1a3"/><circle cx="172" cy="100" r="1" fill="%239bd6e8"/><circle cx="240" cy="14" r="1" fill="%23f5ecd2"/></g></svg>';
  /* CSS data URLs need < > " encoded for parser to accept */
  function enc(s){ return s.replace(/"/g, '\'').replace(/</g, '%3C').replace(/>/g, '%3E'); }
  var urlLight = 'url("data:image/svg+xml;utf8,' + enc(svgLight) + '")';
  var urlDark  = 'url("data:image/svg+xml;utf8,' + enc(svgDark)  + '")';
  ...
  s.textContent = [
    /* Light mode */
    'html body .navbar.w-nav,html body nav.w-nav,html body header.po-nav.po-nav{background-image:' + urlLight + '!important;background-repeat:repeat!important;background-size:320px 120px!important;background-position:0 0!important;background-blend-mode:normal!important;background-color:#f5efe2!important}',
...
(function(){
  ...
  s.textContent = [
    ...
    'html[data-theme="dark"] body .w-dropdown-link:hover{color:#f6c1a3!important;background-color:rgba(246,193,163,0.14)!important;text-decoration:underline!important;text-underline-offset:3px!important;font-style:italic!important}',
    /* Light mode dropdown sub-items get the same italic + underline treatment */
    'html body .w-dropdown-link:hover{text-decoration:underline!important;text-underline-offset:3px!important;font-style:italic!important}',
